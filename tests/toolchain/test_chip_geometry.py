...
# chip -> (RAMSTART, SRAM bytes, has JMP/CALL)
CHIPS = {
    "atmega48":   (0x100, 512,  False),
    "atmega48p":  (0x100, 512,  False),
    "atmega88":   (0x100, 1024, False),
    "atmega88p":  (0x100, 1024, False),
    "atmega168":  (0x100, 1024, True),
    "atmega168p": (0x100, 1024, True),
    "atmega328":  (0x100, 2048, True),
    "atmega328p": (0x100, 2048, True),
    "atmega32u4": (0x100, 2560, True),
    "atmega2560": (0x200, 8192, True),
    "attiny13":   (0x60,  64,   False),
    "attiny13a":  (0x60,  64,   False),
    "attiny24":   (0x60,  128,  False),
    "attiny25":   (0x60,  128,  False),
    "attiny2313": (0x60,  128,  False),
    "attiny44":   (0x60,  256,  False),
    "attiny45":   (0x60,  256,  False),
    "attiny4313": (0x60,  256,  False),
    "attiny84":   (0x60,  512,  False),
    "attiny85":   (0x60,  512,  False),
}
