# PyMCU -- held-write-named: a write through a method on a field holding a NAMED instance.
#
...
# marking walk never saw it. Unmarked, the constructor never materialized its store and the
