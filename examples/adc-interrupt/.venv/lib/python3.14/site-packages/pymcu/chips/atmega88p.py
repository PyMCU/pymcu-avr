...
# -----------------------------------------------------------------------------
#
# ATmega88P -- picoPower variant of ATmega88.
# 1 KB SRAM, 8 KB flash; identical register map to ATmega328P.
# -----------------------------------------------------------------------------
...
device_info(chip="atmega88p", arch="avr", ram_size=RAM_SIZE)

# ==========================================
#  Register Definitions (ATmega88P)
# ==========================================
