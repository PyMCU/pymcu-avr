...
# -----------------------------------------------------------------------------
#
# ATtiny13A -- 8-pin AVR, PORTB only (PB0-PB5 usable, PB5=RESET)
# 64B SRAM, 1KB flash, 64B EEPROM. picoPower variant of ATtiny13.
# Note: ATtiny13A does NOT have a hardware multiplier (AVRe core).
...
device_info(chip="attiny13a", arch="avr", ram_size=RAM_SIZE)

# ==========================================
#  Register Definitions (ATtiny13A)
# ==========================================
# Register map is identical to ATtiny13; picoPower variant only.
