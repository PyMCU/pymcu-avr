...
# -----------------------------------------------------------------------------
#
# ATmega168P -- picoPower variant of ATmega168.
# 1 KB SRAM, 16 KB flash; identical register map to ATmega328P.
# -----------------------------------------------------------------------------
...
device_info(chip="atmega168p", arch="avr", ram_size=RAM_SIZE)

# ==========================================
#  Register Definitions (ATmega168P)
# ==========================================
