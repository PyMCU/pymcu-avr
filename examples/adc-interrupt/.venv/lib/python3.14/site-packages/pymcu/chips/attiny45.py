...
# -----------------------------------------------------------------------------
#
# ATtiny45 -- 8-pin AVR, PORTB only (PB0-PB5 usable, PB5=RESET)
# 256B SRAM, 4KB flash, 256B EEPROM
# Note: ATtiny45 does NOT have a hardware multiplier (AVRe core).
...
device_info(chip="attiny45", arch="avr", ram_size=RAM_SIZE)

# ==========================================
#  Register Definitions (ATtiny45)
# ==========================================
...
# Timer/Counter 1 (8-bit, ATtiny45 specific)
