...
# -----------------------------------------------------------------------------
#
# ATmega328 -- identical register map to ATmega328P, same 2 KB SRAM.
# The only differences from ATmega328P are the device signature bytes and the
# absence of a dedicated bootloader section; all I/O addresses are the same.
# -----------------------------------------------------------------------------
