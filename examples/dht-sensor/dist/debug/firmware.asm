...
; main.py:20: from whipsnake.boards.arduino_uno import D2, LED_BUILTIN
; main.py:32: 
	LDI	R24, 1
	TST	R24
	BRNE	L_BR_SKIP_10
...
L_BR_SKIP_22:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pind_wait_lo_b2
	MOV	R16, R24
	CPI	R24, 0
	BRNE	L_BR_SKIP_23
	RJMP	L_127
L_BR_SKIP_23:
	...
	MOV	R13, R24
	MOV	R14, R25
	CALL	whipsnake_hal__gpio_atmega328p__pind_meas_lo_b2
	STD	Y+20, R24
	STD	Y+21, R25
L_127:
	RJMP	L_119
...
L_BR_SKIP_24:
	...
	MOV	R7, R24
	MOV	R8, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinb_wait_lo_b2
	MOV	R16, R24
	CPI	R24, 0
	BRNE	L_BR_SKIP_25
	RJMP	L_139
L_BR_SKIP_25:
	...
	MOV	R5, R24
	MOV	R6, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinb_meas_lo_b2
	STD	Y+20, R24
	STD	Y+21, R25
L_139:
	RJMP	L_119
...
L_BR_SKIP_26:
	...
	MOV	R11, R24
	MOV	R12, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinc_wait_lo_b2
	MOV	R16, R24
	CPI	R24, 0
	BRNE	L_BR_SKIP_27
	RJMP	L_148
L_BR_SKIP_27:
	...
	MOV	R9, R24
	MOV	R10, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinc_meas_lo_b2
	STD	Y+20, R24
	STD	Y+21, R25
L_148:
L_119:
...
L_BR_SKIP_29:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pind_wait_hi_b2
	MOV	R16, R24
	CPI	R24, 0
	BRNE	L_BR_SKIP_30
	RJMP	L_162
L_BR_SKIP_30:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pind_meas_hi_b2
	STD	Y+20, R24
	STD	Y+21, R25
L_162:
	RJMP	L_154
...
L_BR_SKIP_32:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinb_wait_hi_b2
	MOV	R16, R24
	CPI	R24, 0
	BRNE	L_BR_SKIP_33
	RJMP	L_183
L_BR_SKIP_33:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinb_meas_hi_b2
	STD	Y+20, R24
	STD	Y+21, R25
L_183:
	RJMP	L_154
...
L_BR_SKIP_35:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinc_wait_hi_b2
	MOV	R16, R24
	CPI	R24, 0
	BRNE	L_BR_SKIP_36
	RJMP	L_199
L_BR_SKIP_36:
	...
	STD	Y+54, R24
	STD	Y+55, R25
	CALL	whipsnake_hal__gpio_atmega328p__pinc_meas_hi_b2
	STD	Y+20, R24
	STD	Y+21, R25
L_199:
L_154:
...
; main.py:48:             print("H:", sensor.humidity, " T:", sensor.temperature, sep="")
	...
	CALL	__uart_send_z
	LDD	R24, Y+25
	CALL	whipsnake_hal__uart_avr_uart_write_decimal_u8
	MOV	R16, R24
	LDI	R30, lo8(__str_4)
	LDI	R31, hi8(__str_4)
	CALL	__uart_send_z
